...
(defconst parse-it-java--into-level-symbols
  '("BRKT_CR_OPN" "BRKT_SQ_OPN" "PAREN_OPN")
  "All symbols that goes into one nested level.")

(defconst parse-it-java--back-level-symbols
...
(defun parse-it-java (path)
  ...
  (let* ((parse-it-lex--token-type (parse-it-java--make-token-type))
    ...
    (parse-it-ast-build token-list
                        parse-it-java--into-level-symbols
                        parse-it-java--back-level-symbols)))

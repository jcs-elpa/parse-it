...
(defconst parse-it-css--token-type
  '(("COMMENT_BEG" . "/[*]+")
    ...
    ("KEYWORD" . "\\<\\(caption-size\\|caret-color\\|@charset\\|clear\\|clip\\|color\\|column-count\\|column-fill\\|column-gap\\|column-rule-color\\|column-rule-style\\|column-rule-width\\|column-rule\\|column-span\\|column-width\\|columns\\|content\\|counter-increment\\|counter-reset\\|cursor\\)")
    ("KEYWORD" . "\\<\\(direction\\|display\\|empty-cells\\)")
    ("KEYWORD" . "\\<\\(filter\\|flex-basis\\|flex-direction\\|flex-flow\\|flex-grow\\|flex-shrink\\|flex-wrap\\|flex\\|float\\|@font-face\\|font-family\\|font-feature-settings\\|@font-feature-values\\|font-kerning\\|font-language-override\\|font-size-adjust\\|font-size\\|font-stretch\\|font-style\\|font-synthesis\\|font-variant-alternates\\|font-variant-caps\\|font-variant-east-asian\\|font-variant-ligatures\\|font-variant-numeric\\|font-variant-position\\|font-variant\\|font-weight\\|font\\)")
    ...
    ("KEYWORD" . "\\<\\(hanging-punctuation\\|height\\|hyphens\\image-rendering\\|@image\\|isolation\\|justify-content\\|@keyframes\\|left\\|letter-spacing\\|line-break\\|line-height\\|list-style-image\\|list-style-position\\|list-style-type\\|list-style\\)")
    ("KEYWORD" . "\\<\\(margin-bottom\\|margin-left\\|margin-right\\margin-top\\|margin\\|max-height\\|max-width\\|@media\\|min-height\\|min-width\\|mix-blend-mode\\|object-fit\\|object-position\\|opacity\\|order\\|orphans\\|outline-color\\|outline-offset\\|outline-style\\|outline-width\\|outline\\|overflow-wrap\\|overflow-x\\|overflow-y\\|overflow\\)")
